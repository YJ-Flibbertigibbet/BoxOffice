...
#====================config=========================
model_path = "/home/juan/桌面/NKU/数据分析/box_office/res_fc/trainpth/model_res_img_1.pth"
#===================================================

def test_model(model_path,split):
    if split==False:
        ...
        dataset = data.dataset(boxDataFile=config.textBoxDataFile)
...
if __name__ == "__main__":
    result_df = test_model(model_path, split=False)

    result_df.to_csv("res_results/test_results.csv", index=False)
